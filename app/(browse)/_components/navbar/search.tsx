...
export const Search = () => {
    ...
    return (
        ...
        <form className="relative w-full lg:w-2/4 lg:mr-2 flex items-center" onSubmit={onSubmit}>
            <Input placeholder="Search" className="rounded-r-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0" value={value}
